 ...
 * @returns 
 */
async function ssweb(url, defaultViewport, fullPage, filetype) {
    ...
    try {
        ...
        const bodyHeight = await page.evaluate(() => document.body.scrollHeight);   // Body Height is same as FullPage.
        ...
        const screenshot = await page.screenshot({
            ...
            clip: {
                ...
                height: fullPage ? bodyHeight>0?bodyHeight:10800 : defaultViewport.height
            }
        });
        await browser.close();
