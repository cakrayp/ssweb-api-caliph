...
module.exports = async function uploadFile(buffer) {
    return new Promise(async (resolve, reject) => {
        ...
        fetch('https://uploader.caliph.my.id/backend/upload.php', {
            ...
            .then(async ({ result }) => {
                const base_for_file = ['https://uploader.caliph.my.id', 'https://filezone.cf'];
            ...
            .catch(async (err) => {
                ...
                reject({
                    ...
                    message: {
                        error: true,
                        messageError: "Service Unavailable, because this program file upload is down or maybe an error.",
